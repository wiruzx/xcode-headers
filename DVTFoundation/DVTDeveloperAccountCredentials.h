...
+ (id)_accountCredentialsFromUsername:(id)arg1 alternateDSID:(id)arg2 token:(id)arg3 keychain:(struct OpaqueSecKeychainRef *)arg4 successfullyPersisted:(char *)arg5 error:(id *)arg6;
+ (id)_accountCredentialsFromUsername:(id)arg1 password:(id)arg2 keychain:(struct OpaqueSecKeychainRef *)arg3 successfullyPersisted:(char *)arg4 error:(id *)arg5;
...
- (id)_accountCredentialsWithPassword:(id)arg1 keychain:(struct OpaqueSecKeychainRef *)arg2 successfullyPersisted:(char *)arg3 error:(id *)arg4;
