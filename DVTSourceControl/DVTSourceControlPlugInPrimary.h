...
- (void)createWorkingCopyFromRepository:(id)arg1 location:(id)arg2 branchAndTagLocations:(id)arg3 localAddress:(id)arg4 existingAddress:(id)arg5 progressIdentifier:(id)arg6 completionBlock:(CDUnknownBlockType)arg7;
