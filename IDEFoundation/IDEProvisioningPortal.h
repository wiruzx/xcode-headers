...
+ (id)_errorForNoMatchingTeamWithID:(id)arg1;
+ (id)concurrentQueue;
...
- (struct DVTPortalOperationToken *)_singleTeamTokenForAccount:(id)arg1 teamID:(id)arg2 error:(id *)arg3;
- (id)provisioningDevicesForTeamWithID:(id)arg1 program:(id)arg2 session:(id)arg3 error:(id *)arg4;
- (id)portalTeamWithID:(id)arg1 session:(id)arg2 error:(id *)arg3;
...
- (id)_containerTypesToValuesFromLegacyRequiredFeatures:(id)arg1 error:(id *)arg2;
- (id)_featuresToValuesFromLegacyRequiredFeatures:(id)arg1 error:(id *)arg2;
