...
- (CDUnknownBlockType)launchParametersBlockForEnvironmentVariables:(id)arg1 commandLineArguments:(id)arg2 buildParameters:(id)arg3 enableCodeCoverage:(BOOL)arg4 enableAddressSanitizer:(BOOL)arg5 shouldGenerateOptimizationProfile:(BOOL)arg6 shouldDebugXPCServices:(BOOL)arg7 shouldDebugAppExtensions:(BOOL)arg8;
