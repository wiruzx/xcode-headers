...
@interface _IDETestManagerAPIMediator : _IDETestResultsProcessor <XCTestManager_IDEInterface, IDEConsoleAdaptorDelegateProtocol, IDETestingDiagnosticLogWriter>
{
