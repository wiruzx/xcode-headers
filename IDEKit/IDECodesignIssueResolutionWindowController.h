...
@interface IDECodesignIssueResolutionWindowController : DVTPagingSheetWindowController_AppKitAutoLayout
{
    ...
    IDECodesignIssueResolutionDescription *_resolutionDescription;
    CDUnknownBlockType _resolutionDescriptionCallback;
    IDECodesignIssueAlertConfiguration *_alertConfig;
    IDECodesignResolutionInputs *_codesignResolutionInputs;
}

@property(copy) IDECodesignResolutionInputs *codesignResolutionInputs; // @synthesize codesignResolutionInputs=_codesignResolutionInputs;
@property(retain) IDECodesignIssueAlertConfiguration *alertConfig; // @synthesize alertConfig=_alertConfig;
@property(copy) CDUnknownBlockType resolutionDescriptionCallback; // @synthesize resolutionDescriptionCallback=_resolutionDescriptionCallback;
@property(retain) IDECodesignIssueResolutionDescription *resolutionDescription; // @synthesize resolutionDescription=_resolutionDescription;
...
- (void)_invokeResolutionOption:(id)arg1 callback:(CDUnknownBlockType)arg2;
- (void)_initialSetup;
...
- (id)initWithIssueResolutionnDescription:(id)arg1 callback:(CDUnknownBlockType)arg2;
