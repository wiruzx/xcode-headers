...
@interface IDECodesigningSettingsViewController : IDEViewController <NSMenuDelegate>
{
    ...
    DVTObservingToken *_developmentTeamSelectionObserver;
}

@property(retain) DVTObservingToken *developmentTeamSelectionObserver; // @synthesize developmentTeamSelectionObserver=_developmentTeamSelectionObserver;
